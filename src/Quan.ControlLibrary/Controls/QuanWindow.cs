...
namespace Quan.ControlLibrary
{
    ...
    public class QuanWindow : Window
    {
        ...
        public static readonly DependencyProperty TitleBarHeightProperty = DependencyProperty.Register("TitleBarHeight", typeof(int), typeof(QuanWindow), new PropertyMetadata(30));
